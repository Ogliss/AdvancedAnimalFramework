...
namespace AnimalJobsPatch
{
	...
	internal static class HarmonyPatches
	{
		...
		public static bool JobDriver_CatchFish_Prefix(JobDriver_CatchFish __instance, ref IEnumerable<Toil> __result)
		{
		...
		public static IEnumerable<Toil> JobDriver_CatchFish_MakeNewToils(JobDriver_CatchFish __instance, Thing ___TargetThingA)
		{
